                                                ...
                                                <div class="col-md-6" v-for="(item, roll) in data.hasServices" :key="item.optionValue" :label="roll">
                                                    <div class="scard p-2">
                                                        <div class="custom-control custom-radio">
                                                            ...
                                                            <label for="action-0-0" class="custom-control-label">{{ item[item[0].selectedService].name }}</label> 
                                                            <p>{{ item[item[0].selectedService].price }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6" v-for="(item, roll) in data.hasServices" :key="item.optionValue" :label="roll">
                                                    <div class="scard p-2">
                                                        <div class="custom-control custom-checkbox">
                                                           ...
                                                           <label :for="index" class="custom-control-label">{{ item[item[0].selectedService].name }} </label>
                                                            <p>{{ item[item[0].selectedService].price }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div @click="editElementProperties(data)">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu w-100" x-placement="bottom-start" style="">
                                                        ...
                                                        <a href="#" click.prevent="1" class="dropdown-item" draggable="false" v-for="(item, roll) in data.hasServices">{{ item[item[0].selectedService].name }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group w-100" >
                                                    <div class="d-flex itemRemove" v-for="(serviceProject, serviceIndex) in activeForm.hasServices">
                                                        <select class="form-control" v-model="serviceProject[0].selectedService">
                                                                ...
                                                                <option v-for="(service, sindex) in serviceProject.slice(1, serviceProject.length)" :key="sindex" :value="sindex+1">
                                                                    <p>{{ service.name }}</p>
                                                                    <p> (${{ service.price }})</p>
                                                                </option>
                                                        </select>
